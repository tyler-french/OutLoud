...
def test_pdf_extraction():
    ...
    assert "bazel" in text.lower() or "build" in text.lower(), "Text should contain relevant content"
...
def test_tts_generation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        log("Generating short audio clip...")
...
def test_end_to_end_pdf_to_audio():
    ...
    from extractor import extract_from_pdf_simple
    from tts import generate_audio_chunked
    ...
    short_text = text[:500]
    log(f"Using first 500 characters for audio generation...")
